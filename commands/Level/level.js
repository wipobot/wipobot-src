const { SlashCommandBuilder, EmbedBuilder, WelcomeChannel, hideLinkEmbed, AttachmentBuilder } = require("discord.js");
const { createCanvas, loadImage } = require("@napi-rs/canvas")
const client = require("../../index")
module.exports = {
    data: new SlashCommandBuilder()
        .setName('level')
        .setDescription('Displays someones xp level!')
        .addUserOption(option => option.setName('user').setDescription('The user who\'s level card you want to get.').setRequired(false)),
